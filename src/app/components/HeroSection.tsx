    ...
    return(
        ...
        <section>
                ...
                <div className="h-[646px] w-full relative">
                    <Image priority={true} fill={true} draggable="false" src={imgArr[0].img} className='w-full h-[646px] drop-shadow-lg object-cover object-center' alt='hero img' quality={100} />
